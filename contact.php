...
<h1 class="text-center text-primary">Central de Atendimento</h1>
...
<fieldset><legend></legend>
    ...
    <form action="../Controller/Register.php" method="post" class="form-signup-login w3-card-4 w3-container" name="formlogin">
        ...
        <div class="form-group box-login">
            ...
            <input type="text" id="input_css" name="cpf_user" id="sobrenome" maxlength="15"  required placeholder="CPF" disabled>
            ...
            <input type="text" id="input_css" name="email_user" id="txt_name"   placeholder="Email" disabled>
