            ...
            <div class="col-sm-12 col-md-10 img-rounded" style="min-height: 400px; background: #fff;">
                ...
                if (isset($_POST["botao"])) {
                    ...
                    $sql = "UPDATE cliente SET
                            end_rua = '" . mysqli_real_escape_string($conexao, $_POST['rua_user']) . "',
                            end_bairro = '" . mysqli_real_escape_string($conexao, $_POST['bairro_user']) . "',
                            end_complemento = '" . mysqli_real_escape_string($conexao, $_POST['complemento_user']) . "',
                            end_cidade = '" . mysqli_real_escape_string($conexao, $_POST['cidade_user']) . "',
                            end_estado = '" . mysqli_real_escape_string($conexao, $_POST['estado_user']) . "',
                            email = '" . mysqli_real_escape_string($conexao, $_POST['email_user']) . "'
                            WHERE id_cliente = ".$_SESSION['id_cliente'].";";

                    mysqli_query($conexao, $sql);

                    echo '<div style="margin:0;" class="alert alert-success text-center" role="alert"><b>Parabéns! Cadastro atualizado com sucesso!</b></div><br>';
                }
                ...
                <form action="cli_cadastro.php" method="post" class="form-signup-login w3-card-4 w3-container" name="formlogin">
                    <div class="form-group box-login">
                        ...
                        <div class="form-group ">
                            ...
                            <input value="<?=$user['email']?>" style="width: 50%; display: inline-block;" type="text" class="form-control text-center" name="email_user" id="txt_email">
                            <label for="txt_senha">Senha</label>
                            <input style="width: 20%; display: inline-block;"type="password" class="form-control text-center" name="senha_user" id="txt_senha">

                        </div>
                        <p class="text-center"><button value="enviar" name="botao" type="submit" class="btn btn-success btn-lg" role="button">Salvar Cadastro</button></p>
